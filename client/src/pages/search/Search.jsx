          ...
          {data.users?.length > 0 && (
            <section>
              ...
              <div className="space-y-2">
                {data.users.map(u => (
                  <Link key={u.id} to={`/profile/${u.id}`} className="flex items-center space-x-3 bg-white dark:bg-gray-800 rounded-xl p-3 border border-gray-200 dark:border-gray-700 hover:shadow-sm transition-shadow">
